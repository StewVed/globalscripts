...
, supportStewved =
  ...
  + '<hr>'
  + '<div id=BraveBAT>'
  + '<a href="https://brave.com/ste944" target="_blank">'
  + '<img src="' + gs + 'images/brave-bat-partnership.svg" alt="Brave Browser & BAT" class="editEnable" width="75%">'
  + '</a>'
  ...
  + '<a href="https://brave.com/ste944" target="_blank">'
  + '<img src="' + gs + 'images/brave-logotype-dark.svg" alt="Download Brave Browser" class="editEnable" width="50%">'
  + '</a>'
  + '<br>'
  ...
  + '<form class="tipButton uButtonGrey" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">' + '<input type="hidden" name="cmd" value="_s-xclick">' + '<input type="hidden" name="hosted_button_id" value="RJMCJX2TE8E4Y">'
    + '<input type="image" class="imgSocs ubLink editEnable" ' + imgSocs + 'PaypalDonate.png\');height:100%;width:100%;display:block;cursor: pointer;" ' + imgDummy + ' name="submit" alt="PayPal – The safer, easier way to pay online.">'
  + '</form>'
  + '</div>'
  + '<br>'
