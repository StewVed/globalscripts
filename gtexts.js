...
,  appAbout =
  ...
  + '<p style="text-align:justify;margin-top: 0;">'
    ...
    + 'which can be viewed, forked, commented on, etc. through GitHub.'
  + '</p>'
  ...
  + '<p style="text-align:justify;">'
    ...
    + 'web ever since!'
  + '</p>'
  + '<hr style=clear:both>' + appBugs

, appTips =
    '<h2 class="B pZW">Free apps with your support!</h2>'
      //Button-link to my Patreon site
    + '<div class="btn btnGrey">'
      + '<a class=\'ubLink\' href=\'https://www.patreon.com/stewved\' target=\'_blank\'><img class="imgSocs ubLink" ' + imgSocs + 'Patreon.png\');cursor:pointer;display:block;width:100%;height:4em;"' + imgDummy + '></a>'
    + '</div>'
      //PayPal Donate Button (modded)
    + '<form class="btn btnGrey" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">' + '<input type="hidden" name="cmd" value="_s-xclick">' + '<input type="hidden" name="hosted_button_id" value="RJMCJX2TE8E4Y">'
      + '<input type="image" class="imgSocs ubLink" ' + imgSocs + 'PaypalDonate.png\');height:47px;width:100%;margin:4px auto;display:block;cursor: pointer;" ' + imgDummy + ' name="submit" alt="PayPal – The safer, easier way to pay online.">'
    + '</form>'
;
